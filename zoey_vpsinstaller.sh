...
curl -skL "https://github.com/freenetsapinas/sshscript/raw/main/badvpn-udpgw" -o /usr/local/bin/badvpn-udpgw 
	chmod +x /usr/local/bin/badvpn-udpgw
    # Change link boss ng badvpn-udpgw.service
	curl -skL "https://raw.githubusercontent.com/freenetsapinas/sshscript/main/badvpn-udpgw.service" -o /lib/systemd/system/badvpn-udpgw.service
...
wget -q 'https://github.com/freenetsapinas/sshscript/raw/main/zoey.zip'
unzip -qq zoey.zip
rm -f zoey.zip
chmod +x ./*
dos2unix ./* &> /dev/null
...
function OVPNFixer(){
 ...
 wget -qO /etc/openvpn/ovpn_fixer.bash "https://raw.githubusercontent.com/freenetsapinas/sshscript/main/ovpn_fixer.bash"
...
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/freenetsapinas/sshscript/main/prem.sh -q
}
...
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/freenetsapinas/sshscript/main/vip.sh -q
}
...
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/freenetsapinas/sshscript/main/private.sh -q
}
